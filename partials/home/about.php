...
<div class="pat-about row expanded" data-equalizer data-equalize-on="medium">
    ...
    <div class="small-12 medium-6 medium-push-6 large-3 large-push-9 columns image-container" data-equalizer-watch>

        <?php echo wp_get_attachment_image( get_post_meta( get_the_ID(), '_rbm_pat_home_about_image', true ), 'full' ); ?>

    </div>

    <div class="small-12 medium-6 medium-pull-6 large-9 large-pull-3 columns text-container" data-equalizer-watch>
